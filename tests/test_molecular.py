...
class TestRepresentations:
    ...
    def test_rdkit_descriptors_shape(self):
        from science.molecular.representations import DESCRIPTOR_NAMES, rdkit_descriptors
    ...
    def test_smiles_to_graph(self):
        from science.molecular.representations import ATOM_FEATURE_DIM, BOND_FEATURE_DIM, smiles_to_graph
    ...
    def test_tokenize_smiles(self):
        from science.molecular.representations import detokenize_smiles, tokenize_smiles
...
class TestEvaluation:
    ...
    def test_bootstrap_ci(self):
        from science.molecular.evaluation import auroc, bootstrap_ci
